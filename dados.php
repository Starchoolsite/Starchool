        ...
        <div class="container">
            <div class="row row-lg-eq-height">
                ...
                <form action="autenticacao.php" method="POST">
                    <div class="col-lg-6">
                        <div class="form_title">Entrar</div>
                        <form action="#" id="contact_form" class="contact_form">
                            ...
                            <div class="row contact_row">
                                ...
                                <div class="col">
                                    <button name="entrar" class="form_button trans_200">
                                        Entrar
                                    </button>
                                </div>
                                <div class="col">
                                    <button class="form_button trans_200">
                                        <a href="./registrar.php" class="form_button trans_200">Cadastre-se</a>
                                    </button>
